      ...
      <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-5 order-md-3">
                <div class="footer-info text-md-center">
                  <a href="{{ route('home') }}" class="logo d-flex align-items-md-center justify-content-md-center">
                    <x-logo/>
                  </a>
                  <p>Your safety is our number 1 priority</p>
                </div>
            </div><!-- End footer info column-->
            <div class="col-lg-2 col-md-4 footer-links order-md-4">
                <p>
                    A108 Adam Street <br>
                    NY 535022, USA<br><br>
            ...
            <div class="col-lg-2 col-md-4 footer-links order-md-2">
                <h4>Our Services</h4>
                <ul>
            ...
            <div class="col-lg-2 col-md-4 footer-links order-md-5">
                    <h4>Follow us</h4>
