<section id="hero" class="hero">
    ...
    <div id="hero-carousel" class="carousel p-0 slide">

        <div class="info d-flex align-items-center">
            <div class="container">
                <div class="row justify-content-center justify-content-md-start">
                    <div class="col-lg-8 text-center text-md-start">
                        <h1 class="fs-4 text-white text-uppercase">We Understand Your needs on</h1>
                        <h2 class="text-primary">Safety . Health . Environment</h2>
                        <h4 data-aos="fade-up" class="text-white d-none" data-aos-delay="400">Elevate Your Safety Standards With our expert Solutions, expert guidance and reliable support.</h4>
                    </div>
                </div>
            </div>
        </div>
