        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-3 col-md-4" data-aos="fade-up" data-aos-delay="100">
                <div class="service-item  position-relative shadow-sm">
                    ...
                    <p>Our comprehensive safety assessments identify potential hazards and risks within your workplace.</p>
                    <a href="{{ route('solutions') }}" class="readmore stretched-link">Learn more <i class="bi bi-arrow-right"></i></a>
                </div>
